              ...
              <div className="wallet-connected-wrapper">
                ...
                {showAccountsDropdown && (
                  <div className="accounts-dropdown">
                    <div className="dropdown-overlay" onClick={() => setShowAccountsDropdown(false)} />
                          ...
                          getAvailableAccounts().map((accountAddress, index) => (
                            ...
                            >
                              ...
                              <div className="account-details">
                                ...
                                <div className="account-address">{formatAddress(accountAddress)}</div>
                              </div>
