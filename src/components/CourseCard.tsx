...
export const CourseCard = ({ course }: CourseCardProps) => {
  ...
  const { hasPurchased, refetchPurchaseStatus } = useHasUserPurchasedCourse(course.courseId, address || '')
  ...
  }, [purchaseIsConfirmed, refetchPurchaseStatus, addPurchasedCourse, course.courseId, refetchBalance])
